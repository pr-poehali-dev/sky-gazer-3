        ...
        <div className="h-[400px] sm:h-[600px] lg:h-[800px] sticky top-[calc(100vh-400px)] sm:top-[calc(100vh-600px)] lg:top-[calc(100vh-800px)]">
          <div className="bg-neutral-950 py-8 px-8 md:px-16 h-full w-full flex flex-col justify-between">
            <div className="flex flex-col sm:flex-row gap-12 sm:gap-20">
              ...
              <div className="flex flex-col gap-2">
                <h3 className="mb-3 uppercase text-neutral-500 text-xs tracking-[0.3em]">Работы</h3>
                <a href="#works" className="text-white hover:text-[#C8FF00] transition-colors duration-300 text-sm">
                  Брендинг
                </a>
                <a href="#works" className="text-white hover:text-[#C8FF00] transition-colors duration-300 text-sm">
                  Веб-дизайн
              ...
              <div className="flex flex-col gap-2 sm:ml-auto">
                <h3 className="mb-3 uppercase text-neutral-500 text-xs tracking-[0.3em]">Статус</h3>
